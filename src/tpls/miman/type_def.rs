...
const ENTITY_TYPE_DEF_CODES: &str = r#"// Code generated by whale_fall. DO NOT EDIT.
...
impl EntityTypeImport {
    pub fn execute(&self) -> Result<String> {
        render_template(ENTITY_TYPE_DEF_CODES, self)
    }
}
...
impl EntityTypeMap {
    pub fn execute(&self) -> Result<String> {
        render_template(ENTITY_TYPE_DEF, self)
    }
}
